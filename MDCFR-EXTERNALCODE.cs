...
#pragma warning restore CS8601
            ...
            public interface IAsyncEnumerable<out T>
            {
                ...
                /// <param name="cancellationToken">A <see cref="System.Threading.CancellationToken" /> that may be used to cancel the asynchronous iteration.</param>
    ...
    #nullable disable
            ...
            {
                /// <summary>Initializes a new instance of the <see cref="System.Runtime.CompilerServices.AsyncIteratorStateMachineAttribute" /> class.</summary>
...
#nullable disable
    ...
    namespace Numerics
    {
        ...
        internal static class BitOperations
        {
            ...
            private static int Log2SoftwareFallback(uint value)
            {
                ...
                value |= value >> 8;
                value |= value >> 16;
                return Unsafe.AddByteOffset<byte>(ref MemoryMarshal.GetReference(Log2DeBruijn), (IntPtr)(nint)(value * 130329821 >> 27));
            }
        }
    ...
    internal sealed class DefaultBinder : Binder
    {
        ...
        {
            if (type is RoType roType)
            {
                return roType.Loader == _loader;
            }
            return false;
        }
            ...
            for (int k = 0; k < array.Length; k++)
            {
                if (indexes != null)
                {
                    ...
                    for (j = 0; j < num2; j++)
                    {
                        ...
                        if (parameterType == indexes[j] || parameterType == _objectType)
                        {
                            continue;
                        }
                        if (parameterType.IsPrimitive)
