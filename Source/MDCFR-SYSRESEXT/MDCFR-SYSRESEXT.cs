...
#pragma warning disable CS1591, CS8602 , CS8767
#nullable enable
...
namespace System.Resources.Extensions
{
    ...
    internal sealed class RuntimeResourceSet : ResourceSet, IEnumerable
    {
            ...
            base()
        {
            ...
            _defaultReader = reader as DeserializingResourceReader ?? throw new ArgumentException(SR.Format(MDCFR.SysResExt.Properties.Resources.NotSupported_WrongResourceReader_Type, reader.GetType()), nameof(reader));
        ...
        private IDictionaryEnumerator GetEnumeratorHelper()
        {
            ...
            if (reader is null)
                throw new ObjectDisposedException(null, MDCFR.SysResExt.Properties.Resources.ObjectDisposed_ResourceSet);
    ...
    public partial class PreserializedResourceWriter
    {
        ...
        public void AddResource(string name, string value, string typeName)
        {
            ...
            if (s_primitiveTypes.TryGetValue(typeName, out Type? primitiveType))
            {
                ...
                else
                {
                    ...
                    if (converter == null)
                    {
                        throw new TypeLoadException(SR.Format(MDCFR.SysResExt.Properties.Resources.TypeLoadException_CannotLoadConverter, primitiveType));
                    }
        ...
        public void AddActivatorResource(string name, Stream value, string typeName, bool closeAfterWrite = false)
        {
            ...
            if (!value.CanSeek)
                throw new ArgumentException(MDCFR.SysResExt.Properties.Resources.NotSupported_UnseekableStream);
                    ...
                    case SerializationFormat.ActivatorStream:
                        {
                            ...
                            if (stream.Length > int.MaxValue)
                                throw new ArgumentException(MDCFR.SysResExt.Properties.Resources.ArgumentOutOfRange_StreamLength);
...
#pragma warning restore SYSLIB0011
        ...
        private object DeserializeObject(int typeIndex)
        {
            ...
            switch (format)
            {
                case SerializationFormat.BinaryFormatter:
                    {
                        ...
                        if (length < 0)
                        {
                            throw new BadImageFormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourceDataLengthInvalid, length));
                        }
                ...
                case SerializationFormat.TypeConverterByteArray:
                    {
                        ...
                        if (converter == null)
                        {
                            throw new TypeLoadException(SR.Format(MDCFR.SysResExt.Properties.Resources.TypeLoadException_CannotLoadConverter, type));
                        }
                ...
                default:
                    throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_TypeMismatch);
            }
            ...
            if (value.GetType() != type)
                throw new BadImageFormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResType_SerBlobMismatch, type.FullName, value.GetType().FullName));
    ...
    public sealed partial class DeserializingResourceReader : IResourceReader
    {
        ...
        public DeserializingResourceReader(Stream stream)
        {
            ...
            if (!stream.CanRead)
            {
                throw new ArgumentException(MDCFR.SysResExt.Properties.Resources.Argument_StreamNotReadable);
            }
        ...
        private void SkipString()
        {
            ...
            if (stringLength < 0)
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_NegativeStringLength);
            }
        ...
        private unsafe int GetNamePosition(int index)
        {
            ...
            {
                throw new FormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesNameInvalidOffset, r));
            }
            return r;
        }
        ...
        {
            if (_resCache == null)
                throw new InvalidOperationException(MDCFR.SysResExt.Properties.Resources.ResourceReaderIsClosed);
            ...
            lock (this)
            {
                for (int i = lo; i <= hi; i++)
                {
                    ...
                    if (CompareStringEqualsName(name))
                    {
                        ...
                        {
                            throw new FormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesDataInvalidOffset, dataPos));
                        }
                        return dataPos;
                    }
                }
        ...
        private unsafe bool CompareStringEqualsName(string name)
        {
            ...
            if (_ums != null)
            {
                ...
                {
                    throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesNameTooLong);
                }
            ...
            else
            {
                ...
                while (numBytesToRead > 0)
                {
                    ...
                    if (n == 0)
                        throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourceNameCorrupted);
                    numBytesToRead -= n;
                }
            ...
            lock (this)
            {
                ...
                if (_ums != null)
                {
                    if (_ums.Position > _ums.Length - byteLen)
                        throw new BadImageFormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesIndexTooLong, index));
                    ...
                    {
                        throw new FormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesDataInvalidOffset, dataOffset));
                    }
                    return s;
                }
                ...
                while (count > 0)
                {
                    ...
                    if (n == 0)
                        throw new EndOfStreamException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourceNameCorrupted_NameIndex, index));
                    count -= n;
                }
                dataOffset = _store.ReadInt32();
                if (dataOffset < 0 || dataOffset >= _store.BaseStream.Length - _dataSectionOffset)
            ...
            lock (this)
            {
                ...
                if (_version == 1)
                {
                    ...
                    if (FindType(typeIndex) != typeof(string))
                        throw new InvalidOperationException(SR.Format(MDCFR.SysResExt.Properties.Resources.InvalidOperation_ResourceNotString_Type, FindType(typeIndex).FullName));
                    s = _store.ReadString();
                }
                else
                {
                    ...
                    if (typeCode != ResourceTypeCode.String && typeCode != ResourceTypeCode.Null)
                    {
                        ...
                        throw new InvalidOperationException(SR.Format(MDCFR.SysResExt.Properties.Resources.InvalidOperation_ResourceNotString_Type, typeString));
                    }
        ...
        private object? LoadObjectV1(int pos)
        {
            ...
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_TypeMismatch, eof);
            }
            catch (ArgumentOutOfRangeException e)
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_TypeMismatch, e);
            }
        }
                ...
                case ResourceTypeCode.ByteArray:
                    {
                        ...
                        if (len < 0)
                        {
                            throw new BadImageFormatException(SR.Format(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourceDataLengthInvalid, len));
                        }
        ...
        private void ReadResources()
        {
            ...
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesHeaderCorrupted, eof);
            }
            catch (IndexOutOfRangeException e)
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesHeaderCorrupted, e);
            }
        }
        ...
        private void _ReadResources()
        {
            ...
            if (magicNum != ResourceManager.MagicNumber)
                throw new ArgumentException(MDCFR.SysResExt.Properties.Resources.Resources_StreamNotValid);
            ...
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_ResourcesHeaderCorrupted);
            }
            ...
            else
            {
                ...
                if (!ValidateReaderType(readerType))
                    throw new NotSupportedException(SR.Format(MDCFR.SysResExt.Properties.Resources.NotSupported_WrongResourceReader_Type, readerType));
            ...
            if (version != CurrentVersion && version != 1)
                throw new ArgumentException(SR.Format(MDCFR.SysResExt.Properties.Resources.Arg_ResourceFileUnsupportedVersion, CurrentVersion, version));
            _version = version;
        ...
        private Type FindType(int typeIndex)
        {
            ...
            {
                throw new NotSupportedException(MDCFR.SysResExt.Properties.Resources.ResourceManager_ReflectionNotAllowed);
            }

            if (typeIndex < 0 || typeIndex >= _typeTable.Length)
            {
                throw new BadImageFormatException(MDCFR.SysResExt.Properties.Resources.BadImageFormat_InvalidType);
            }
        ...
        internal sealed class ResourceEnumerator : IDictionaryEnumerator
        {
            ...
            public object Key
            {
                get
                {
                    if (_currentName == ENUM_DONE) throw new InvalidOperationException(MDCFR.SysResExt.Properties.Resources.InvalidOperation_EnumEnded);
                    if (!_currentIsValid) throw new InvalidOperationException(MDCFR.SysResExt.Properties.Resources.InvalidOperation_EnumNotStarted);
                    if (_reader._resCache == null) throw new InvalidOperationException(MDCFR.SysResExt.Properties.Resources.ResourceReaderIsClosed);
    ...
    // default file format.
    //
    public sealed partial class PreserializedResourceWriter : IResourceWriter
    {
        ...
        public PreserializedResourceWriter(Stream stream)
        {
            ...
            if (!stream.CanWrite)
            {
                throw new ArgumentException(MDCFR.SysResExt.Properties.Resources.Argument_StreamNotWritable);
            }
        ...
        public void AddResource(string name, string? value)
        {
            ...
            {
                throw new InvalidOperationException(MDCFR.SysResExt.Properties.Resources.InvalidOperation_ResourceWriterSaved);
            }
        ...
        private static ResourceTypeCode FindTypeCode(object? value, List<string> types)
        {
            ...
            else
            {
                ...
                throw new PlatformNotSupportedException(MDCFR.SysResExt.Properties.Resources.NotSupported_BinarySerializedResources);
            }
...
#pragma warning restore CS1591, CS8602 , CS8767
