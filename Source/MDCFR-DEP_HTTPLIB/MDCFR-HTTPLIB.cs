...
This File includes the j6mes HTTP Library.
License File:
Apache License
...
namespace HTTPLIB 
{
	...
	// Builder\RequestBuilder.Header.cs file: <--
	public partial class RequestBuilder
    {
	...
	// Provider\ActionProvider.cs file: <--
	...
	// Provider\AuthenticationProvider.cs file: <--
    ...
    [ROOT.AsInterface(typeof(AuthenticationProvider))]
	public struct BasicAuthenticationProvider : AuthenticationProvider
    {
        ...
        {
            return System.Convert.ToBase64String(Encoding.UTF8.GetBytes(string.Format("{0}:{1}", username, password)));
        }
    }
	// Ends here: -->
	
	// Provider\BodyProvider.cs file: <--
    ...
    // Provider\DefaultBodyProvider.cs file: <--
    [ROOT.AsInterface(typeof(BodyProvider))]
    ...
    // Provider\DictionaryHeaderProvider.cs file: <--
    [ROOT.AsInterface(typeof(HeaderProvider))]
	...
	// Provider\FormBodyProvider.cs file: <--
	...
	// Provider\HeaderProvider.cs file: <--
    ...
    // Provider\MultiHeaderProvider.cs file: <-- 
    [ROOT.AsInterface(typeof(HeaderProvider))]
	...
	// Provider\MultipartBodyProvider.cs file: <--
    ...
    // Provider\NonActionProvider.cs file: <--
    [ROOT.AsInterface(typeof(ActionProvider))]
    ...
    // Provider\SettableActionProvider.cs file: <--
    [ROOT.AsInterface(typeof(ActionProvider))]
	...
	// Provider\StreamBodyProvider.cs file: <--
    ...
    // Provider\TextAuthenticationProvider.cs file: <--
    [ROOT.AsInterface(typeof(AuthenticationProvider))]
	...
	// Provider\TextBodyProvider.cs file: <--
	...
	// Streams\ProgressCallbackHelper.cs file: <--
	...
	// Streams\ProgressChangedEventArgs.cs file: <--
	...
	// Streams\ProgressMonitorStream.cs file: <--
