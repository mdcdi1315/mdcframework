...
namespace ROOT
{
	...
	public static class MAIN 
	{
		...
		public sealed class DialogsReturner
		{
			private string ERC;
			private string FNM;
			...
			/// </summary>
			public enum FileDialogType : System.Int32 { CreateFile = 0, LoadFile = 2, DirSelect = 4 }
			...
			/// <summary>
			/// The Error code string that is returned. A generic error is indicated by the <code>"Error"</code> <see cref="System.String"/>.
			/// </summary>
		...
		{
			try { return System.IO.File.OpenWrite(Path); } catch (System.Exception) { return null; }
		}
	...
	public static class HW31Strings
	{
		...
		private static readonly System.Object[,] Mapper = { { 0 , "AA" } , { 1 , "AB" } , { 2 , "AC" } , { 3 , "AD" } , { 4 , "AE" } , { 5 , "AF" } ,
		...
		{
			for (System.Int32 I = 0; I < Mapper.Length; I++)
			{
				if (System.Convert.ToInt32(Mapper[I, 0]) == Value) { return $"{Mapper[I, 1]}"; }
			}
			return "Error";
		}
		...
		private static System.Byte CharsToCorrespondingByte(System.String Chars)
		{
			...
			for (System.Int32 I = 0; I < Mapper.Length; I++)
			{
				if ((System.String)Mapper[I, 1] == Chars) { return System.Convert.ToByte(Mapper[I, 0]); }
			}
			return 0;
		}
		...
		public static System.String ByteArrayToHW31String(System.Byte[] Array)
		{
			if (Array.Length < 1) { return null; }
			System.String Result = null;
			for (System.Int32 I = 0; I < Array.Length; I++)
			{
				if (ByteToCorrespondingChars(System.Convert.ToByte(Mapper[Array[I], 0])) != "Error")
				{
					Result += (ByteToCorrespondingChars(System.Convert.ToByte(Mapper[Array[I], 0])) + " ");
				}
				else { return "Error"; }
			}
			return Result;
		...
		/// </summary>
		/// <param name="HW31">The already created HW31 <see cref="System.String"/>. </param>
		/// <returns>A new <see cref="System.Byte"/>[] containing the byte data kept by the HW31 string.</returns>
		public static System.Byte[] HW31StringToByteArray(System.String HW31)
		{
			if (TestIfItIsAnHW31String(HW31) == false) { return null; }
			System.Char[] HW31Arr = HW31.ToCharArray();
	...
	/// </summary>
	internal enum SupportedOSAttributePlatforms : System.Int32 { Windows = 2 , OSX = 3, Linux = 4 }
...
namespace ExternalHashCaculators
{
	...
	/// </summary>
	[ROOT.SupportedOS(ROOT.SupportedOSAttributePlatforms.Windows)]
