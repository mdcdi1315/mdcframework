...
namespace ExternalCryptographicMethods
{
	
	namespace zeyadetmanMethods
	{
		
		//	This Namespace contains the fundamentals to convert fixed strings to
		//	Hexadecimal numbers and the opposite , encrypting them to DES standard.
		//	It is implemented by Zeyad Etman:
		//	GitHub: http:\\github.com\zeyadetman
		...
		{
			// Summary: This encrypts the given plain text with the given key.
			// Arguments:
			// The plain text.
			// The key.
			...
			// Summary: This decrypts the given cipher text with the given key.    
			// Arguments:
			// The plain text.
			// The key.
			...
			// Summary: Finds the key of the given Plain text and cipher text. 
			// Arguments:
			// The plain text.
			// The cipher text.
		...
		{
			// Implements the ICryptographicTechnique above.
		}
	
		public class DESImplementation : CryptographicTechnique
		{
		...
		public class TripleDESImplementation : ICryptographicTechnique<string, List<string>>
		{
